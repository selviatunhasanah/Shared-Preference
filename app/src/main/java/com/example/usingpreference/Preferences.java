...
public class Preferences {
    ...
    static final String KEY_USERNAME_SEDANG_LOGIN = "Usename_logged_in";
    ...
    public static void setRegisteredUser(Context context, String username){
        ...
        editor.putString(KEY_PASS_TEREGISTER, username);
        editor.apply();
    }
    ...
    public static void getLoggedInUser(Context context, String username){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
